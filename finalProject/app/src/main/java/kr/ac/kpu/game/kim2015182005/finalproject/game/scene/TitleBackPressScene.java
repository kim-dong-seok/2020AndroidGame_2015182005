...
public class TitleBackPressScene extends GameScene {
        ...
        private static TitleBackPressScene instance;
        public enum Layer {
    ...
    private void initObjects() {
        ...
        TextObject tbAt = new TextObject("게임을 종료 하시겠습니까?", cx, cy - UiBridge.y(40), 50, "#FFFFFF", true);
    ...
    public static TitleBackPressScene get() {return instance; }
