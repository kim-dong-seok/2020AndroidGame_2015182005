...
|날짜|계획|세부계획|진행도|
|-----|-----|-----|-----|
|5/1(월)~|플레이어 캐릭터 구현|캐릭터 리소스 수집 및 편집  캐릭터 클래스 구현(기본 상태, 점프, 근거리 공격, 원거리 공격) ||
|6/3(수)~|적 구현|리소스 수집 및 편집  에너미 클래스 구현(기본 상태, 이동, 공격)||
...
|6/12(금)~|상호작용 오브젝트 추가|플레이어가 상호작용 가능한 오브텍트 추가(아이템, 분기점)||
